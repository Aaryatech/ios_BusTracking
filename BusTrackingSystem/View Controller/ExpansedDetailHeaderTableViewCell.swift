//
//  ExpansedDetailHeaderTableViewCell.swift
//  BusTrackingSystem
//
...
class ExpansedDetailHeaderTableViewCell: UITableViewCell {
    ...
    @IBOutlet weak var imgGrievance: UIImageView!
    ...
    var isExpanded:Bool = false
        ...
        didSet
        {
            if !isExpanded {
                ...
                self.ViwHightConstraint.constant = 450.0
                self.htViewSpace.constant=0
                self.htStatusView.constant=35
                upperView.backgroundColor = UIColor(red: 210/255, green: 210/255, blue: 210/255, alpha: 0.8)
