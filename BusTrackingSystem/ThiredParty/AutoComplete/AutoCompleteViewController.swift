...
open class AutoCompleteViewController: UIViewController {
    ...
    override open func viewDidLoad() {
        ...
        self.top = self.delegate!.top()
        self.ContainerView = self.delegate!.ContainerView()
        self.height = self.delegate!.autoCompleteHeight()
        self.view.frame = CGRect(x: self.ContainerView!.frame.minX,
            y: top,
            width: self.ContainerView!.frame.width,
            height: self.ContainerView!.frame.height)
        print(self.ContainerView!.frame.minY)
