...
private class AKCollectionViewCell: UICollectionViewCell {
    ...
    var highlightedBackgroundColor = UIColor.red
    var BackgroundColor1 = UIColor.white
	var _selected: Bool = false {
		didSet(selected) {
            ...
            if self.isSelected
            {
            self.label.backgroundColor = self.highlightedBackgroundColor
            }
            else
            {
            self.label.backgroundColor = self.BackgroundColor1
            }
...
public class AKPickerView: UIView, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, AKCollectionViewLayoutDelegate {
  ...
  public lazy var BackgroundColor1: UIColor = UIColor.white
    ...
    @IBInspectable public lazy var highlightedBackgroundColor: UIColor = UIColor.red
	...
	*/
	...
	public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
		...
		if let title = self.dataSource?.pickerView?(self, titleForItem: indexPath.item) {
            ...
            cell.BackgroundColor1=self.BackgroundColor1
            cell.highlightedBackgroundColor=self.highlightedBackgroundColor
            
            
            if indexPath.row == selectedItem
            {
               cell.backgroundColor=self.BackgroundColor1
            }
            else
            {
